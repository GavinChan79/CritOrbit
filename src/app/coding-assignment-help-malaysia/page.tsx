  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 md:px-6">
          <SectionHeading eyebrow="Internal Links" title="Related Assignment Help" description="Explore more CritOrbit pages for coding-adjacent and urgent assignment support." />
